...
class CrawlImdSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        item['public'] = response.xpath('//div[@class="TitleBlock__TitleMetaDataContainer-sc-1nlhx7j-2 hWHMKr"]/ul/li[3]/span/text()').get()
        ...
        item['episodes'] = response.xpath('//section[@cel_widget_id="DynamicFeature_Episodes"]/div/a/h3/span/text()').get()
